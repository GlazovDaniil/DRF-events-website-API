...
## *Задачи*:
 - Создать группы пользователей: администратор, пользователь (организатор/участник) ![image](https://github.com/GlazovDaniil/DRF-events-website-API/assets/78955311/15acfaa6-bd6d-4b3e-9769-ece66d11ff99)
 - "Умный календарь" записи в аудитории для проведения мероприятий
 - Теги как у мероприятий, так и у пользователей ![image](https://github.com/GlazovDaniil/DRF-events-website-API/assets/78955311/3d473744-90b0-4393-b302-2a9cde448ad8)
