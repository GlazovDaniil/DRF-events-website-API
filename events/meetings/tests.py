...
class MeetingTest(TestCase):
    ...
    def test_meeting_content(self):
        ...
        # Запрос на создание мероприятия без параметров
        ...
        # Запрос на создание мероприятия без обязательного параметра author
        ...
        # Запрос на создание мероприятия без обязательного параметра title
        print("- title")
        ...
        # Запрос на создание мероприятия без обязательного параметра place
        print("- place")
        content = self.responce_pattern_content(token, {"author": [1],
                                                        "title": ["Body content..."]})
        self.assertEqual(content['place'][0], "Обязательное поле.",
        ...
        # Запрос на создание мероприятия c неверным параметраметром author
        ...
        # Запрос на создание мероприятия c неверным параметраметром title
        print("- title")
        content = self.responce_pattern_content(token, {"author": [1],
                                                        "title": "",
                                                        "place": [1]})
        ...
        # Запрос на создание мероприятия c неверным параметраметром place
        print("- place")
        content = self.responce_pattern_content(token, {"author": [1],
                                                        "title": ["Body content..."],
                                                        "place": ""})
...
class TokenTest(TestCase):
    ...
    def test_get_token(self):
        ...
        # Аунтефикация правильным токеном
        ...
        # Аунтефикация неправильным токеном
        print('Аунтефикация неправильным токеном')
        ...
        # Аунтефикация по пустому токену
        print('Аунтефикация по пустому токену')
        ...
        # Аунтефикация по пустому полю для токена
        print('Аунтефикация по пустому полю для токена')
